...
dE_E_angle::dE_E_angle(TTree *inT, TTree *outT, TString inFile)
{
	...
	gcut_he6 = new TCutG("He6",maynard->gcut_noPoints(s_curFile, "he6.dat", cs::runNo),&in_AZ,&in_aF5);
																								...
																								std::vector<Float_t> &ptr_stdV_Sqrang_2H)
{
	...
	for (Long64_t entry=0; entry<nEntries; entry++)
	{
		...
		Float_t ToFMWPC = 440.0/(cos(vBeam->Theta()));
		Float_t det_thcknss = 1000.0/(cos(vBeam->Theta()));
